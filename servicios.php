      ...
      <div class="row content">
        <div class="nav nav-stacked affix-top col-xs-12 col-sm-3 col-sm-offset-0
          ...
          <div class="list-group   nav nav-stacked" >
            <a href="#" class="list-group-item active">Busqueda</a>
            <a href="#como" class="list-group-item">Alineacion</a>
            <a href="#experiencia" class="list-group-item">Evaluacion</a>
            <a href="#valores" class="list-group-item">Descripcion de puesto</a>
            <a href="#" class="list-group-item ">Busqueda</a>
            <a href="#como" class="list-group-item">Alineacion</a>
            <a href="#experiencia" class="list-group-item">Evaluacion</a>
            <a href="#valores" class="list-group-item">Descripcion de puesto</a>
            <a href="#" class="list-group-item ">Busqueda</a>
