...
<main> 
 <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar" style="position: fixed;" id="nav-servicios">
          <ul class="nav nav-sidebar">
            <li><a href="#busqueda">Busqueda</a></li>
            <li><a href="#alineacion">Alineacion</a></li>
            <li><a href="#evaluacion">Evaluacion</a></li>
          
          
            <li><a href="#descripcion">Descripcion de puesto</a></li>
            <li><a href="#ref-empresa">Referente a su empresa</a></li>
            <li><a href="#responsabilidades">Responsabilidades del puesto</a></li>
            <li><a href="#caracteristicas">Características del candidato</a></li>
            <li><a href="#competencias">Competencias del candidato</a></li>
          
          
            <li><a href="#desarrollo">Desarrollo del candidato</a></li>
            <li><a href="#estrategia">Estrategia de la beúsqueda</a></li>
            <li><a href="#cv">Currículum vitae</a></li>
            <li><a href="#buen-cv">Un Buen currículum vitae</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="sevicios-main">
          <div class="col-xs-9 col-xs-offset-3 main" id="busqueda">
            <h2>Búsqueda</h2>
            <p>
          ...
          <!-- <hr> -->
          <div class="line-divider" id="alineacion"></div>
          <div class="col-xs-9 col-xs-offset-3 main">
            <h2> Reforzamiento de los Sistemas Gerenciales</h2>
            <p>
          ...
          <div class="line-divider" id="evaluacion"></div>
          <div class="col-xs-9 col-xs-offset-3 main">
            <h2>Evaluación de ejecutivos a través de "Success Insights"</h2>
            <p>
          ...
          <div class="line-divider" id="descripcion"></div>
          <div class="col-xs-9 col-xs-offset-3 main">
            <h2>¿Cómo hacer una descripción de puesto?</h2>
            <p>
            ...
            <br>
            <!-- SUB TOPICO -->
            <h3 id="ref-empresa">Referente a la Empresa:</h3>
            <ul>
              <li>
          ...
          <!-- SUB TOPICO -->
          <br>
          <h3 id="responsabilidades">Responsabilidades del puesto que busca:</h3>
          <ul>
            <li>
          ...
          <br>
          <h3 id="caracteristicas">Características individuales del candidato que busca</h3>
          <p>
          ...
          <br>
          <h3 id="competencias">Competencias del candidato que busca</h3>
          <p>
          ...
          <br>
          <h3 id="desarrollo">Desarrollo a futuro para el candidato</h3>
          <p>
          ...
          <br>
          <h3 id="estrategia">Estrategia  que se seguirá en la búsqueda</h3>
          <p>
            Ubicación de las compañías que se contactarán. <br>
            Características especiales (nacional y/o multinacional, giro (s),  tamaño, etc.). <br>
            Puestos que se contactarán, compañías que no se deben considerar. <br>
            Compañías y candidatos recomendados, candidatos en quienes no hay interés. <br>
            Aspectos especiales de la estrategia.
          </p>

          </div> <!-- the las col-xs-9 thingy -->

          <div class="line-divider" id="cv"></div>
          <div class="col-xs-9 col-xs-offset-3 main">
            <h2>¿Cómo hacer un C.V.?</h2>
            <p>
            ...
            <h3>Lo que debe contener: </h3>            
            <ul>
              <li>
                Nombre, dirección, teléfono de casa y trabajo, celular personal, email personal, fecha de nacimiento, nacionalidad, estatus migratorio, estado civil, número de hijos, idiomas, universidades (¿de qué año a qué año?), postgrados (año en que se cursó y universidades), cursos curriculares (número de horas por curso y año en que los tomó), cursos extracurriculares, hobbies (lo que te gusta hacer que hable de ti, por ejemplo: motociclismo, jogging, actividades culturales, lectura, etc. ),
              </li>
              <li>
                Último trabajo primero (cuenta regresiva). En cada descripción de trabajo se requiere: definición escueta de actividad de compañía, tamaño (personas y volumen) productos y marcas más conocidas, ¿a quién se reporta? ¿cuáles puestos le reportan?, 
              </li>
              <li>
                Descripción de responsabilidades básicas, logros importantes en forma escueta en puestos recientes, 
              </li>
              <li>
                Otros intereses o logros que hablen de la persona que no sean laborales (participación en una ONG o publicaciones, etc.), asociaciones profesionales y clubes sociales. 
              </li>
            </ul>
            <p>
            ...
            <p>
              NOTA: Es muy importante incluir fechas exactas: mes y año. (Una fecha en general cuando estuvo en la empresa, y fechas precisas para cada puesto).
            </p>
            <ul>
              <li>
                No. de cartilla, no. de pasaporte, no. de licencia de conducir, no. de cédula profesional, copias de títulos, listado interminable de seminarios y cursos. 
              </li>
              <li>
            ...
            <p>Evite mencionar lo siguiente: <br>
